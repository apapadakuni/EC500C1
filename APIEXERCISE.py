...
def to_movie(twitterusername):

    os.environ["GOOGLE_APPLICATION_CREDENTIALS"]=os.getcwd()+"\keys.json"
    ...
    for media_file in media_files:
        if counter <200:
            counter = counter +1 
            location = os.getcwd() + "\\" + str(counter).zfill(3) + '.jpg'
        #if (counter < 10):
    ...
    for num in range(0, counter+1):
        counter2 = counter2 + 1
        filename = str(counter2).zfill(3) + '.jpg'
        path = os.getcwd()
        ...
        new = 'new' + str(counter2).zfill(3)+'.jpg'
    ...
    os.system('ffmpeg -y -framerate 2 -i "new%03d.jpg" output.mp4')
    return responses
